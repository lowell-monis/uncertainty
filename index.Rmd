...
subtitle: "A hands-on tutorial on how to accessibly and viscerally* visualize confidence and significance of a multiple regression model within two dimensions"
author: 
...
You also want to predict the height of someone weighing 250 lbs. This is outside the predictor data range. So, when you use the model here, you *extrapolate*. Extrapolation is generally not a good practice, and can result in false correlations.
